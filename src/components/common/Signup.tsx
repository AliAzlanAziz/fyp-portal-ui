    ...
    <div className="container">
      <div className="row d-flex align-items-center justify-content-center">
        <div className="form-container">
          {role === UserRoles.ADMIN && <h3 className="title">Admin Signup</h3>} 
          {role === UserRoles.ADVISOR && <h3 className="title">Advisor Signup</h3>} 
          {role === UserRoles.PANEL && <h3 className="title">Panel Signup</h3>} 
          {role === UserRoles.STUDENT && <h3 className="title">Student Signup</h3>}
          <form className="form-horizontal">
            ...
            {(role === UserRoles.ADVISOR || role === UserRoles.PANEL) && (
              <div className="form-group">
                <label>Department{role === UserRoles.ADVISOR && <span className="text-danger">*</span>}</label>
                <input
                  type="text"
                  className="form-control"
